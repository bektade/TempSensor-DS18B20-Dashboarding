...
def format_temperature(value: float) -> float:
...
class DS18B20Sensor:
    ...
    def build_payload(self, timestamp: int | None = None) -> dict[str, str | float | int]:
        ...
        return {
            ...
            'temperature_c': format_temperature(temp_c),
            'temperature_f': format_temperature(temp_f),
        }
